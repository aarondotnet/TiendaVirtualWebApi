...
function libroscorrecto(libros) {
    ...
    $.each(libros, function (key, libro) {
        ...
        $linea.find('.AuthorName').text(libro.Nick);
        $linea.find('.Title').text(libro.Password);
...
function libroactualizar(e) {
    ...
    $.getJSON(this.href, function (libro) {
        ...
        $('#inputGenre').val(libro.Nick);
        $('#inputPrice').val(libro.Password);
...
function librodetalle(e) {
    ...
    $.getJSON(this.href, function (libro) {
        ...
        $('#Title').text(libro.Nick);
        $('#Year').text(libro.Password);
